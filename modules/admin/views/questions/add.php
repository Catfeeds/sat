...
<div class="span10">
    <div >
        ...
        <span>添加题目</span>
            ...
            若有短文、图片先<a><span id="addessay">添加</span></a> </br>
            若无短文、图片，请直接<a><span id="addquestion">添加题目</span></a></br></br>
        ...
        <span>
            <select name="sourceId">
                ...
                <?php foreach($arr as $v){?>
                    <option value ="<?php echo $v['id']?>" <?php echo isset($data)&& $data['sourceId']==$v['id'] ?  'selected':''?>><?php echo $v['name'].$v['time']?></option>
                <?php }?>
            </select>
        </span>
        </br>
