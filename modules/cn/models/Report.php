    ...
    */
    ...
    function Show($uid,$id)
    {
        ...
        if($data){
            ...
            $suggest['Math']    = Yii::$app->db->createCommand("select suggestion from {{%tactics}} where max>" . $re['Math']  . "  and min<" . $re['Math'] . " and major='Mock-Math'")->queryOne();
            $suggest['Reading'] = Yii::$app->db->createCommand("select suggestion from {{%tactics}} where max>" . $re['Reading']  . "  and min<" . $re['Reading'] . " and major='Mock-Reading'")->queryOne();
            $suggest['Writing'] = Yii::$app->db->createCommand("select suggestion from {{%tactics}} where max>" . $re['Writing']  . "  and min<" . $re['Writing']." and major='Mock-Writing'")->queryOne();
