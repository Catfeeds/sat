...
<div class="work-mk">
    ...
    <div class="work-mk-btm container">
        <div class="work-btm-cnt row">
            ...
            <div class="work-sec-process col-lg-4 col-md-4">
                本section进度:<span class="sec-position">0</span>/<span><?php echo $amount?></span>
            </div>
            <div class="work-all-process col-lg-2 col-md-2">
                做题总进度:<span class="all-position">0</span>/<span>154</span>
            </div>
    ...
    <div class="worl-btm-hidden">
        ...
        <!--本section总题目-->
        <input type="hidden" id="sectionAllNum" value="<?php echo $amount?>">
        <!--本section当前题目-->
