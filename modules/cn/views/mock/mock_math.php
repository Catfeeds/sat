...
<div class="work-mk">
    ...
    <div class="work-mk-top container">
        <div class="work-top-cnt row">
            ...
            <h1 class="work-main-title col-lg-8 col-md-8">NEW SAT<i>  </i><span class="work-subhead"> <?php echo $data['name'].'-'.$data['time']?> <?php echo $data['major']?> Section <?php echo $data['section']?></span></h1>
