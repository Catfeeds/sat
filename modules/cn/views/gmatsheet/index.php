...
<section class="gmat-open">
	<div class="openClass">
	     ...
	     <table cellspacing="0">
	         ...
	         <tr>
	             <td>GMAT 强化班（连授班）</a></td>
	             <td>3月、4月、5月、6月、7月、8月</td>
	             <td>申友团队</td>
	             <td>全国</td>
	             <td class="open-apply">
                 <a href="http://p.qiao.baidu.com/im/index?siteid=6058744&ucid=3827656&cp=&cr=&cw=" target="_blank">在线报名 </a></td>
	         </tr>
	         <tr>
	             <td>GMAT 强化班（周末班）</a></td>
	             <td>3月-8月周末开班</td>
	             <td>申友团队</td>
	             <td>全国</td>
	             <td class="open-apply">
    ...
    <ul>
        <li>
            ...
            <div class="dynamic-right">
                <h4>考试动态</h4>
                <ul>
                    <li><a href="#" target="_blank">如何突破GMATSC高分瓶颈</a></li>
                    <li><a href="#" target="_blank">GMAT备考中究竟如何使用GMAT机经【申友解</a></li>
                    <li><a href="#" target="_blank">耶鲁大学入学申请条件及费用</a></li>
                </ul>
                <div class="moreDiv">
        ...
        <li>
            ...
            <div class="dynamic-right">
                <h4>名师观点</h4>
                <ul>
                    <li><a href="#" target="_blank">申友赴美名校考察团—哈佛商学院篇</a></li>
                    <li><a href="#" target="_blank">带你和世界500强的大牛们真实接触！</a></li>
                    <li><a href="#" target="_blank">雷哥GMAT在线学习平台重磅发布</a></li>
                </ul>
                <div class="moreDiv">
