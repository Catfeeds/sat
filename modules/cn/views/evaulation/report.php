    ...
    <div class="score">
        ...
        <div class="wrap">
            <ul class="score-top clearfix">
                <li class="total">测评总分：<span><?php echo $data['score']['score']?></span>分
                <li>总正确率<span><?php echo ceil($data['score']['score'] / 120 * 100) ?></span>%</li>
            ...
            <div class="score-cnt clearfix">
                ...
                <div class="score-table fl">
                    <table>
                        ...
                        <tr <?php if($data['score']['score']<60) echo ' class="score-bc"';?>>
                            <td>0-59分</td>
                            <td>不及格</td>
                            <td>0-4000</td>
                            <td>较弱</td>
                        </tr>
                        <tr <?php if($data['score']['score']>=60&&$data['score']['score']<91) echo ' class="score-bc"';?>>
                            <td>60-90分</td>
                            <td>良好</td>
                            <td>4000-7000</td>
                            <td>良好</td>
                        </tr>
                        <tr <?php if($data['score']['score']>90) echo ' class="score-bc"';?>>
                            <td>90-120分</td>
                            <td>优秀</td>
                            <td>7000-15000</td>
                            <td>优秀</td>
                ...
                <div class="box-left fl">
                    ...
                    <ul class="single-num">
                        <?php foreach ($data['que'][1] as $k => $v) { ?>
                            <li class="<?php echo $v[0] == 1 ? 'green' : 'red' ?>"><a
                                    href="/exercise_details/<?php echo $v[1] ?>.html"><?php echo $k + 1 ?></a></li>
                        <?php } ?>
                    </ul>
                </div>
    ...
    <div class="language">
        ...
        <div class="language-wrap clearfix">
            ...
            <div class="lang-font fl">
                <?php echo $data['score']['score'] ?>
                ：<?php echo $data['suggest']['All'] != false ? $data['suggest']['All'] : '无' ?>
            </div>
        </div>
    </div>
    <!--  SAT报班建议-->
