...
<body>
  ...
  <section>
      ...
      <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="item active">
            <img src="../images/course-bg01.png" alt="First slide">
          </div>
          <div class="item">
            <img src="../images/course-bg01.png" alt="Second slide">
          </div>
          <div class="item">
            <img src="../images/course-bg01.png" alt="Third slide">
          </div>
        </div>
        <!-- 轮播（Carousel）导航 -->
    ...
    <div class="s-w1200">
      ...
      <ul class="s-new-cnt">
        <li>
          <img src="../images/class_img01.png" alt="">
      ...
      <div class="s-history-title">
        <img src="../images/class_bg02.png" alt="">
        <h2>往期公开课</h2>
      </div>
  ...
  <footer class="s-footer">
    <div class="s-footer-top">
      <div class="s-w1200 clearfix">
        ...
        <div class="s-qr">
          <img src="../images/qr-code01.png" alt="">
          <p>SAT公众号</p>
        </div>
        <div class="s-qr">
          <img src="../images/qr-code01.png" alt="">
